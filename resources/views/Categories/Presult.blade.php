                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <button class="btn btn-outline btn-primary dim" type="button" onclick="getDetailCustomer({{$floor->id}})" data-toggle="modal" data-target="#myModal2"><i class="fa fa-edit"></i></button>
